...
two_tigers = ["C4:4", "D4:4", "E4:4", "C4:4", "C4:4", "D4:4", "E4:4", "C4:4", "E4:4", "F4:4", "G4:8", "E4:4", "F4:4", "G4:8"]
...
JoyStick.PlayScale(SCALE['C'])
JoyStick.PlayScale(SCALE['D'])
JoyStick.PlayScale(SCALE['E'])
JoyStick.PlayScale(SCALE['F'])
JoyStick.PlayScale(SCALE['G'])
JoyStick.PlayScale(SCALE['A'])
JoyStick.PlayScale(SCALE['B'])
JoyStick.PlayScale(SCALE['C1'])
JoyStick.Playmusic(two_tigers)
JoyStick.Playmusic(music.FUNK)
